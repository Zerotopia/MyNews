...
/**
 * Class that Mock NYService. This class is use for Unit Test and
 * Instrumental Test.
 */
public class NYServiceMock implements NYService {
    ...
    @Override
    public Observable<Results> searchArticle(String topic, String beginDate, String endDate, String filter, String apikey) {
        Results results = generateCode("SEARCH : ");
        return mBehaviorDelegate.returningResponse(results).searchArticle(topic, beginDate, endDate, filter, apikey);
    }
